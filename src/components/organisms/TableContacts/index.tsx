import {
  ...
  LinearProgress, Box, TableContainer,
  Button, Paper, Grid, TableBody, TableRow,
  TableCell, Pagination, Typography,
} from '@mui/material';
...
function TableContacts({
  order, handleOrder, onGoContactDelete,
  onGoContactsNew, onGoContactEdit, data,
  onChangePage, handleSetSearch, search, loading,
}: TableContactsProps) {
